...
START:
	...
	;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	; A20게이트 활성화
	; BIOS를 이용한 전환 실패시 시스템 컨트롤 포트로 전환 시도
	;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	;BIOS 서비스 이용
	mov ax, 0x2401	;A20게이트 활성화 설정
	int 0x15	;BIOS인터럽트 서비스 호출
	
	jc .A20GATEERROR	;A20게이트 활성화 성공여부 확인
	jmp .A20GATESUCCESS

	.A20GATEERROR
		;에러 발생 시 시스템 컨트롤 포트로 시도
		in al, 0x92	;시스템 컨트롤 포트에서 1바이트 읽어서 al레지스터에 저장
		or al, 0x02	;A20게이트 옵션 비트(1번비트)를 1로 설정
		and al, 0xFE	;시스템 리셋(0번비트) 방지 위해 11111110을 AND 연산하여 비활성화
		out 0x92, al	;옵션 적용. 
	.A20GATESUCCESS
		cli		;인터럽트 발생 못하도록 설정
...
PROTECTMODE:
	...
	jmp dword 0x18: 0x10200				;C언어 커널 존재하는 
							;0x10200주소로 이동하며 C언어 커널 수행		
...
GDT:
	...
	CODEDESCRIPTOR:
		...
		db 0xAF		;G=1, D=0, L=1, Limit[19,16] 보호모드는 D = 1, L = 0
		db 0x00		;Base	[31:24]
